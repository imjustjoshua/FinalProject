...
extern volatile unsigned int average[3];			// x, y, z
extern volatile unsigned int calibratedMAX[3];		// x, y, z
extern volatile unsigned int calibratedMIN[3];		// x, y, z
extern volatile unsigned int calibratedZero[3];		// x, y, z
